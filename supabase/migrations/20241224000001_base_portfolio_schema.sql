-- Base Portfolio Schema Migration
-- Created: 2024-12-24
-- Description: Complete base schema with all core tables for portfolio CMS
...
-- The buckets will be: 'avatars', 'media', 'documents'
-- INSERT INTO storage.buckets (id, name, public) VALUES ('avatars', 'avatars', true);
-- INSERT INTO storage.buckets (id, name, public) VALUES ('media', 'media', true);  
-- INSERT INTO storage.buckets (id, name, public) VALUES ('documents', 'documents', false);

-- Storage policies will need to be added separately:
-- CREATE POLICY "Avatar images are publicly accessible" ON storage.objects FOR SELECT USING (bucket_id = 'avatars');
-- CREATE POLICY "Anyone can upload avatar images" ON storage.objects FOR INSERT WITH CHECK (bucket_id = 'avatars');
-- CREATE POLICY "Users can update their own avatar images" ON storage.objects FOR UPDATE USING (auth.uid()::text = (storage.foldername(name))[1]);
...
COMMENT ON FUNCTION public.handle_new_user() IS 'Create profile record for new users';